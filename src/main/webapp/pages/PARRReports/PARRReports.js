...
Page.onReady = function() {
        ...
        /*    const date = new Date();
            var currentDate = DateCalc(date);
            // var currDate = Date();
            var prvDateMonth = new Date(date.getFullYear(), date.getMonth() - 3, date.getMonth());
            var previousDate = DateCalc(prvDateMonth);
