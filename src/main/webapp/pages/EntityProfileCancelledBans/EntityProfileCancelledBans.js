    ...
    getPayArrangForEntityProfileCancelledVar.invoke({
        ...
        function(data) {
            ...
            if (data.length > 0) {
                ...
                Partial.Widgets.parrSumEntProfCancStatus.caption = data[0].status;
                ...
                App.refreshEntProfCancelRenegotiatedParrSummary();
            }
...
App.refreshEntProfCancelRenegotiatedParrSummary = function() {
    var getPayArrangForEntityProfileCancelledVar = Partial.Variables.getPayArrangForEntityProfileCancelled;
...
Partial.clear_BananchorClick = function($event, widget) {
    ...
    Partial.Widgets.getEntityDetailsTable1_3.selecteditem = false;
};
                ...
                Partial.Variables.save_Document.invoke({},
                    function(data) {
                        ...
                        if (Partial.Widgets.textarea1.datavalue == undefined || Partial.Widgets.textarea1.datavalue == "") {
                            ...
                            var banId = Partial.Widgets.getEntityDetailsTable1_3.selecteditem.banId;
