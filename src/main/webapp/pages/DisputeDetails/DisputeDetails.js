...
Partial.UpdateDisputeSubmitClick = function($event, widget) {
    ...
    } else if (Partial.Widgets.customerEmailUpdate.datavalue !== "" && Partial.Widgets.customerEmailUpdate.datavalue !== null && Partial.Widgets.AssignedDisputePrime.datavalue !== "" && Partial.Widgets.AssignedDisputePrime.datavalue !== null && (custEmailText.toLowerCase() === AssignedDisputePrime.toLowerCase())) {
