...
(function(root, factory) {
    ...
    $.extend(Selectize.prototype, {
        ...
        setup: function() {
            ...
            // IE 11 and Edge fix for invalid argument exception, ref: https://github.com/selectize/selectize.js/pull/1453
        ...
        setActiveItem: function($item, e) {
            ...
            self.hideInput();
            if (!this.isFocused) {
                // self.focus(); // FICO Commented to solve scroll issue when the selectize is used in list
            }
        },
