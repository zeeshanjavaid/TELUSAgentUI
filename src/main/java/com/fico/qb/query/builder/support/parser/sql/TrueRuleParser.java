 ...
 */
public class TrueRuleParser extends AbstractSqlRuleParser {

	@Override
	public boolean canParse(IRule rule) {
		return EnumOperator.TRUE.equals(rule.getOperator());
	}

	@Override
	public Operation parse(IRule rule, JsonRuleParser parser) {
		return new Operation(new StringBuffer(rule.getField()).append(" = ?"), true);
	}
