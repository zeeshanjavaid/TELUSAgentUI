...
package com.fico.qb.query.builder.support.filter;
...
import com.fico.qb.query.builder.exception.FilterException;
import com.fico.qb.query.builder.support.model.IRule;
import com.fico.qb.query.builder.support.model.JsonRule;
import com.fico.qb.query.builder.support.model.enums.EnumBuilderType;
import com.fico.qb.query.builder.support.model.enums.EnumRuleType;
...
public class DatetimeConvertFilter implements IRuleFilter {
    private final static String DEFAULT_DATE_FMT = "MM/dd/yyyy";
    private final static String DEFAULT_TIME_FMT = "HH:mm:ss";
    private final static String DEFAULT_DATETIME_FMT = "MM/dd/yyyy HH:mm:ss";
