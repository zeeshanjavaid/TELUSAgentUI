...
import com.fico.dmp.telusagentuidb.service.DocumentService;
 ...
 * @see Document
 */
@RestController("TELUSAgentUIDB.DocumentController")
@Api(value = "DocumentController", description = "Exposes APIs to work with Document resource.")
@RequestMapping("/TELUSAgentUIDB/Document")
public class DocumentController {

    private static final Logger LOGGER =  FAWBStaticLoggerBinder.getSingleton().getLoggerFactory().getLogger(DocumentController.class.getName());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
	@XssDisable
	public void importDocuments(@RequestPart("file") @Valid @NotNull MultipartFile file) {
        LOGGER.debug("Importing Document table rows from csv");
        documentService.importData(file);
    }
