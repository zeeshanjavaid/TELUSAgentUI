...
public class CollectionTreatmentService {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public List<CollectionActivityLog> getCollectionActivityLog(Integer collectionEntityId, String collectionActivityType, String relatedBusinessEntityId,String category, String createdDate,String createdBy, String status, String assignedTo, String assignedTeam, String completionDate, String fields, Integer offset, Integer limit, Boolean history) throws Exception  {
       if (isStubEnabled) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public List<OrderMgmtHistoryResponse> getOdMgmtHistoryView(Integer collectionEntityId, String type,String id, String category, String createdDate,String createdBy, String status, String assignedTo, String assignedTeam, String completionDate, String fields, Integer offset, Integer limit, Boolean history) throws Exception {
       ...
       // List<CollectionTreatmentStep> collectionTreatmentStep = getCollectionTreatmentStep(false, id, null, null, null, null, null, null, null, null, null, null);
                ...
                List<CollectionActivityLog> collectionActivityLogList = getCollectionActivityLog(collectionEntityId, type,id, category, createdDate, createdBy, status, assignedTo, assignedTeam, completionDate, fields, offset, limit, history);
       ...
       if (!collectionActivityLogList.isEmpty()) {
            for (CollectionActivityLog collectionActivityLog : collectionActivityLogList) {
                ...
                orderMgmtHistoryResponse.setActionId(collectionActivityLog.getId().toString());
