...
public class CollectionTreatmentService {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public List<CollectionActivityLog> getCollectionActivityLog(Integer collectionEntityId, String collectionActivityType,String relatedBusinessEntitySubType, String relatedBusinessEntityId,String relatedBusinessEntityType, String relatedBusinessEntityStatus,String relatedBusinessEntityCreatedDate, String relatedBusinessEntityCreatedBy, String relatedBusinessEntityAssignedTo, String relatedBusinessEntityAssignedTeam,String fields, Integer offset, Integer limit) throws Exception  {
       if (isStubEnabled) {
