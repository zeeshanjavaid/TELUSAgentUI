...
public class CollectionTreatmentService {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public List<OrderMgmtHistoryResponse> getOdMgmtHistoryView(Integer collectionEntityId, String type, String category, String createdDate,String createdBy, String status, String assignedTo, String assignedTeam, String completionDate, String fields, Integer offset, Integer limit, Boolean history) throws Exception {
       ...
       // List<CollectionTreatmentStep> collectionTreatmentStep = getCollectionTreatmentStep(false, id, null, null, null, null, null, null, null, null, null, null);
                ...
                List<CollectionActivityLog> collectionActivityLogList = getCollectionActivityLog(collectionEntityId, type, category, createdDate, createdBy, status, assignedTo, assignedTeam, completionDate, fields, offset, limit, history);
